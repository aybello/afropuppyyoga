...
export default function Careers() {
  ...
  return (
    <div className="min-h-screen bg-[#FEFAF4]">
      ...
      {/* Hero */}
      <section className="pt-28 pb-16 bg-[#1A0A12] relative overflow-hidden">
        <div
          className="absolute inset-0 opacity-10"
          style={{
            backgroundImage: `radial-gradient(circle at 20% 50%, #C2185B 0%, transparent 50%), radial-gradient(circle at 80% 20%, #F2A0B8 0%, transparent 40%)`,
          }}
        />
      ...
      {/* CTA */}
      <section className="py-16 bg-[#1A0A12]">
