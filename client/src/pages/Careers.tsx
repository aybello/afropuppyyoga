...
const JOB_LISTINGS = [
  ...
  },
  {
    ...
    emoji: "📱",
    description:
      "AfroPuppyYoga is looking for a sharp, creative, and self-driven Social Media Intern to help us grow our presence across Instagram, TikTok, and YouTube. You'll be creating content that captures the magic of our classes — the puppies, the vibes, the community — and turning it into scroll-stopping posts, reels, and videos. This is a fast-paced startup environment where your ideas will actually be seen and your work will directly impact the brand.",
    responsibilities: [
      "Create and schedule engaging content for Instagram, TikTok, and YouTube",
      "Design graphics, carousels, and branded assets using Canva",
      "Edit short-form video content using CapCut for Reels and TikToks",
      "Monitor comments, DMs, and community engagement across platforms",
      "Pitch creative content ideas and stay ahead of trending formats",
    ...
    requirements: [
      ...
      "Proficient in Canva and CapCut (portfolio or examples required)",
      "Active understanding of Instagram, TikTok, and YouTube trends",
    ...
    perks: [
      "$18/hr part-time remote role",
      "Creative freedom to shape the brand's voice and aesthetic",
      "Real impact — your content will be seen by thousands",
      "Flexible hours that work around your schedule",
      "Free access to APY classes",
      "Grow with a rapidly expanding wellness brand",
    ],
  },
  {
