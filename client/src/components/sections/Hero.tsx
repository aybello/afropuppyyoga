...
const trustedBy = [
  ...
  { name: "Club Pilates Guelph", src: "https://d2xsxph8kpxj0f.cloudfront.net/310519663446228701/TnRBecMtwf5qQkTJcvZpfJ/club-pilates-correct-logo_9a9b4700.png", height: 44 },
