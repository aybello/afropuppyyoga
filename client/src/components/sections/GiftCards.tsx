    ...
    <section className="py-10 md:py-20 bg-[#F2A0B8]">
      <div className="container">
        <div className="flex flex-col md:flex-row items-center justify-between gap-5 md:gap-8">
          ...
          <FadeUp>
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="font-body text-[#1A0A12]/70 text-sm md:text-lg leading-relaxed max-w-lg">
          ...
          {/* Right */}
          <FadeUp delay={0.15}>
            <div className="flex flex-row md:flex-col lg:flex-row items-center gap-3 shrink-0 w-full md:w-auto">
              <a
                href={GIFT_CARD_URL}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 flex-1 md:flex-none px-5 md:px-8 py-3 md:py-4 bg-[#1A0A12] text-white font-body font-bold text-sm md:text-base rounded-full hover:bg-[#2D1A0A] transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-1"
              >
                <Gift size={18} />
                Buy a Gift Card
              </a>
