    ...
    <section id="experience" className="py-10 md:py-32 bg-[#FFF5F8]">
      <div className="container">
          ...
          <div className="space-y-8">
            ...
            <FadeUp delay={0.5}>
              <a
                ...
                className="inline-flex items-center px-8 py-4 bg-[#8B2252] text-white font-body font-semibold text-base rounded-full hover:bg-[#8B2252] transition-all duration-200 shadow-md hover:shadow-lg hover:-translate-y-0.5"
              >
                Book Your Spot
              </a>
            </FadeUp>
        ...
        <div className="mt-20 md:mt-28 grid grid-cols-2 md:grid-cols-4 gap-8">
          <StatCounter value={3486} suffix="+" label="Happy Participants" delay={0} />
          <StatCounter value={494} suffix="+" label="5-Star Reviews" delay={0.1} />
