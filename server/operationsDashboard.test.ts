...
describe("Run APY dashboard helpers", () => {
  ...
  it("only treats an absent breeder follow-up relation as an optional feed", () => {
    ...
    expect(isMissingBreederFollowUpsTable(new Error("Failed query", {
      cause: Object.assign(new Error("Unknown column 'breederleadfollowups.status' in 'where clause'"), {
