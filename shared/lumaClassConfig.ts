...
const KITCHENER_HAMILTON_FALL_TICKET_LADDER = [
  { label: "Early Bird", suffix: "Early Bird 🐣❤️", cents: 5600, displayPrice: "$56", maxCapacity: 5 },
  { label: "Bring a Friend", suffix: "Bring a Friend 👯‍♀️", cents: 10800, displayPrice: "$108 for 2", maxCapacity: 4 },
  { label: "Group of 3", suffix: "Group of 3 👯‍♀️", cents: 15600, displayPrice: "$156 for 3", maxCapacity: 1 },
  { label: "Regular", suffix: "Regular", cents: 5800, displayPrice: "$58", maxCapacity: 4 },
] as const satisfies readonly RegularClassTicketOption[];

const OAKVILLE_FALL_TICKET_LADDER = [
  { label: "Early Bird", suffix: "Early Bird 🐣❤️", cents: 6100, displayPrice: "$61", maxCapacity: 5 },
  { label: "Bring a Friend", suffix: "Bring a Friend 👯‍♀️", cents: 11800, displayPrice: "$118 for 2", maxCapacity: 4 },
  { label: "Group of 3", suffix: "Group of 3 👯‍♀️", cents: 17100, displayPrice: "$171 for 3", maxCapacity: 1 },
  { label: "Regular", suffix: "Regular", cents: 6300, displayPrice: "$63", maxCapacity: 4 },
] as const satisfies readonly RegularClassTicketOption[];

/**
 * APY Fall ladder. Ticket capacity is measured in purchases:
 * 5 Early Bird seats + 4 two-person friend packages + 1 three-person group
 * package + 4 Regular seats = 20 attendees per time slot.
 */
