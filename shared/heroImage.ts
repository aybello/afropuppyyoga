// The managed-storage route redirects to a signed, no-store URL before the
// browser can download the image. Use the stable CDN asset directly for the
// critical first paint and keep managed storage only as a recovery source.
